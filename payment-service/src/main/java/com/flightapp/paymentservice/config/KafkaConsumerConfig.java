package com.flightapp.paymentservice.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, BookingEvent> consumerFactory() {
        ...
        // KEY FIX: ignore the type header sent by booking-service
        // use our local BookingEvent class instead
        jsonDeser.setRemoveTypeHeaders(true);
        jsonDeser.setUseTypeMapperForKey(false);

        // Wrap in ErrorHandlingDeserializer so bad messages are skipped, not crash-looped
